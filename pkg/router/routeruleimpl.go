...
func init() {
	Register(types.SofaRouterType, &SofaRouteRuleImpl{})
}
...
func (ssri *PrefixRouteRuleImpl) SetMatcher(matcher interface{}) {
}
...
func (ssri *RegexRouteRuleImpl) SetMatcher(matcher interface{}) {
}
